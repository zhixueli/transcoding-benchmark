#
# Script to do benchmark test for Xilinx U30 transcoding performance with h.264 codec settings,
...
#
# Sample:   source 264to264_benchmark_xilinx.sh 16 VT1.3x 2.5M objective
#
